...
import com.jlit.model.SystemParameterValues;
	...
	static {
		try {
			/*applicationContext = new ClassPathXmlApplicationContext(
					"classpath:/com/jlit/xms/resources/applicationContext-dao.xml");
			...
			List<SystemParameterValues> list = ApplicationContextTool.getJdbc().query(ApplicationContextTool.getDataSource(), sql, SystemParameterValues.class, null, 0, 0);
			...
			for (SystemParameterValues spv : list) {
				systemParaMap.put(spv.getName(),spv.getValue());
			}
