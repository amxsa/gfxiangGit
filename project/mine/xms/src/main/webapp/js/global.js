...
//重置密码
function gotoResetPassword(url){
	//top.Dialog.confirm("是否重置密码？",function(){
		...
		diag.OKEvent = function(){
			diag.innerFrame.contentWindow.commitFormVal('savePasswordForm','/uums/saveResetPassword.html');//提交表单
		};
