...
<script language="javascript" type="text/javascript"
	language="javascript">
		...
		function shenhe(id){
			document.forms[0].action="<%=path%>/manager/OrderManagerAction_queryOrderId.do?currentPage=${param.currentPage}&fromPart=updateHBReviewOrder";			
			$("#idQuery").val(id);
			document.forms[0].submit();
		}
...
<body>
	...
	<form action="<%=path%>/manager/OrderManagerAction_showReviewOrder.do"
		...
		<input type="hidden" name="idQuery" value="" id="idQuery"/>
		<div id="main">
			<div id="table">
				<div id="ptk">
