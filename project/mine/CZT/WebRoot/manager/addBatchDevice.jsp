...
<body>
	<div id="main">
		<div id="table">
			<div id="ptk">
				<div id="tabtop-tt" style="width: 150px	">设备导入</div>
			</div>
		</div>
		<div id="table">
			<div id="ptk">
		...
		<div id="main-tab">
			<form
				action="<%=path%>/manager/DeviceManagerAction_addBatchDevice.do"
				method="post" enctype="multipart/form-data">

				<table width="911" align="center" class="table-slyle-hs">
					<tr>
						<td width="150">模板下载：</td>
						<td><a href="<%=path%>/template/sn.xlsx" style="color: red;" title="下载文件">sn.xlsx</a></td>
					</tr>
					<tr>
						<td width="150">选择文件：</td>
						<td><input name="uploadDevice.file" id="file" size="30" type="file"
