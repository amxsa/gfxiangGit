...
<body>
	<div id="main">
		<div id="table">
			<div id="ptk">
				<div id="tabtop-tt" style="width: 150px	">流量卡批量新增</div>
			</div>
		</div>
		<div id="table">
			<div id="ptk">
		...
		<div id="main-tab">
			<form
				action="<%=path%>/manager/FluxCardManagerAction_addBatchFluxCard.do"
				method="post" enctype="multipart/form-data">

				<table width="911" align="center" class="table-slyle-hs">
					<tr>
						<td width="150">模板下载：</td>
						<td ><font ><a href="<%=path%>/template/fluxCard.xlsx" style="color: red;" title="下载文件"> fluxCard.xlsx</a> </font></td>
					</tr>
					<tr>
						<td width="150">选择文件：</td>
						<td><input name="uploadFluxCard.file" size="30" id="file" type="file"
