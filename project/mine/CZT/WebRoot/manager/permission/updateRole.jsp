...
<script language="javascript" type="text/javascript"
	language="javascript">
		function GO() {
			...
			document.forms[0].action="<%=path%>/permission/RoleAction_updateRole.do";
...
<body>
	<div id="main">
		<div id="table">
				<div id="ptk">
					<div id="tabtop-tt" style="width: 150px	">更新角色</div>
				</div>
			</div>
		<div id="table">
			<div id="ptk">
		...
		<div id="main-tab">
			<form action="<%=path%>/permission/RoleAction_updateRole.do" method="post">
			...
			<input type="hidden" name="oldName" value="${role.name }"/>
				<table  width="911" align="center" class="table-slyle-hs">
					<tr >
						...
						<td><input type="text" name="name" id="name" maxlength="50" value="${role.name }"/></td>
					</tr>
					<tr>
						<td>等级：</td>
						<td><input type="text" name="priority" id="priority" maxlength="4" value="${role.priority }"/></td>
					</tr>
					<tr>
						<td>描述</td>
						<td><input type="text" name="description" maxlength="100" value="${role.description }"/></td>
					</tr>
