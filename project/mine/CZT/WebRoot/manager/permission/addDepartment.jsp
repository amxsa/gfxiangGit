...
<script language="javascript" type="text/javascript"
	language="javascript">
		function GO() {
			...
			document.forms[0].action="<%=path%>/permission/DepartmentAction_addDepartment.do";
...
<body>
	<div id="main">
		<div id="table">
				<div id="ptk">
					<div id="tabtop-tt" style="width: 150px	">新增组织</div>
				</div>
			</div>
		<div id="table">
			<div id="ptk">
		...
		<div id="main-tab">
			<form action="<%=path%>/permission/DepartmentAction_addDepartment.do" method="post">
				<table  width="911" align="center" class="table-slyle-hs">
					...
					<tr>
						<td>联系人：</td>
						<td><input type="text" name="linkman" maxlength="10"/></td>
					</tr>
					<tr>
						<td>联系方式</td>
