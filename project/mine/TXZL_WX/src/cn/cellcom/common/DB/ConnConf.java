...
public class ConnConf {
	...
	public ConnConf(Resource resource) {
		try {
			...
			this.driverClassName = DB.getProperty("db95.driverClassName");
			this.url = DB.getProperty("db95.url");
			this.user = DB.getProperty("db95.user");
			this.password = DB.getProperty("db95.password");
		} catch (IOException e) {
