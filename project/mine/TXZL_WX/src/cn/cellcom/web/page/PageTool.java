...
public class PageTool {
	...
	// private int start; //数据下标
	// private int size;
	private String link;

	public PageTool(String currentPage, String link) {
	...
	public PageTool(String currentPage, int pageRecord, String link) {
		if (StringUtils.isBlank(currentPage)) {
			currentPage = "1";
		}
		try {
	...
	public boolean hasPrePage(int currentPage) {
		return currentPage == 1 || currentPage == 0 ? false : true;
	}
