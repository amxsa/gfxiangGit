...
<body>
	<form action="<%=path%>/yfg/UserAction_openTxzlMobile.do" method="post">
		...
		<div class="box">
			...
			<div class="user_2">
				<ul class="list2">
					...
					<li><label>套餐类型</label>
						<select name="setid">
							<option value="51">漏话提醒（2元/月）</option>
							<option value="21">通信助理基础包（4元/月）</option>
							<option value="22">通信助理信息包（10元/月）</option>
						</select>
					</li>
					<li><label>手机号码</label><input type="text" name="mobile"
						maxlength="20" id="mobile" value="" placeholder="" class="b1" />
