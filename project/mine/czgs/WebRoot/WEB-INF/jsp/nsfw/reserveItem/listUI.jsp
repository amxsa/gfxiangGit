...
<head>
    ...
    var listurl="${basePath}/nsfw/reserveItem_listUI.action";
    	function doSearch(){
       ...
       function doEdit(itemId){
    	   document.forms[0].action= "${basePath}/nsfw/reserveItem_editUI.action?item.itemId="+itemId;
    	   document.forms[0].submit();
       } 
       function doDelete(itemId){
    	   document.forms[0].action= "${basePath}/nsfw/reserveItem_delete.action?item.itemId="+itemId;
    	   document.forms[0].submit();
       } 
    </script>
</head>
        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
					...
					<li>
                        处理部门：<s:select name="item.itemDealDept" list="#{'':'全部','部门A':'部门A','部门B':'部门B'}"/>
                    </li>
                    ...
                    <table width="100%" border="0">
                        <tr class="t_tit">
                            ...
                            <tr bgcolor="f8f8f8">
                                ...
                                <td align="center"><s:property value="itemDealDept"/></td>
                                <td align="center"><s:property value="itemDealName"/></td>
                                <td align="center"><s:property value="itemState==1?'有效':'无效'"/></td>
                                <td align="center">
