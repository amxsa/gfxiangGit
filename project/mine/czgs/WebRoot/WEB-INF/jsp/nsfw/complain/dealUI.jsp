...
<form id="form" name="form" action="${basePath }nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:date name="complain.compTime" format="yyyy-MM-dd HH:mm"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
            	<s:iterator value="complain.compReplies" status="st">
        ...
        <tr>
            ...
            <td><s:textarea name="reply.content" cols="90" rows="8" /></td>
        </tr>
    </table>
    <s:hidden name="complain.compId"></s:hidden>
