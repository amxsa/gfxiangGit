...
<head>
    ...
    //账号唯一性效验
    	...
    	function doSubmit(){
    		...
    		if (res) {
				document.forms[0].action="${basePath}/nsfw/user_save.action";
...
<form id="form" name="form" action="#" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:textfield id="birthday" name="user.birthday" readonly="true" onfocus="new WdatePicker({skin:'whyGreen',Fmt:'yyyy-MM-dd'})"/></td>
        </tr>
		<tr>
