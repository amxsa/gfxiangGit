        ...
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="150px">信息创建人</td>
                    <td width="150px">信息创建时间</td>
                </tr>
                <s:iterator value="#request.infoList">
                <tr>
                    <td height="23">
                    <s:url action="home_infoViewUI.action" namespace="/sys" var="infoViewUrl">
                    ...
                    <td width="150px"><s:date name="createTime" format="yyyy-MM-dd HH:ss"/></td>
                </tr>
               </s:iterator> 
            </table>
        </div>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                ...
                <div style="float:right;padding-top:3px; padding-right: 10px">
                	<s:a action="home_complainAddUI.action" namespace="/sys" target="_blank">我要投诉</s:a>
                </div>
            </div>
            <table width="98%" border="0" align="center">
            	<tr>
               ...
               <s:iterator value="#request.compList">
                <tr>
                    <td height="23">
                    <s:url action="home_complainViewUI.action" var="viewCompUrl" namespace="/sys">
                    	<s:param name="comp.compId" ><s:property value="compId"/></s:param>
                    </s:url>
                    <s:a href="%{#viewCompUrl}" target="_blank"><s:property value="compTitle"/></s:a>
                    
                    </td>
                    <td width="180px"><s:property value="{#complainStateMap[state]}"/></td>
                    <td width="180px"><s:property value="isNm?'匿名投诉':'非匿名投诉'"/></td>
                    <td width="180px"><s:date name="compTime" format="yyyy-MM-dd HH:ss"/>
                </tr>
               </s:iterator> 
            </table>
        </div>
