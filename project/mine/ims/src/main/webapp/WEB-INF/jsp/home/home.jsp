        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，&nbsp;</font></a>
                    </td>
...
<div class="menu">
    <ul class="clearfix">
        <li class="hover"><a href="${ctx }/main/home.do">主页</a></li>
        <li><a href="${ctx }/main/nsfw.do">模块一</a> </li>
        <li><a href="javascript:void(0);">模块二</a></li>
    </ul>
</div> --%>
<!-- }导航 -->
<!-- 左{ -->
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                        	<c:choose>
                        		<c:when test="<%-- ${session.SYS_USER.headImg!=null&&session.SYS_USER.headImg!='' } --%>"></c:when>
                        		<c:otherwise><img src="${ctx}/images/home/gs09.png" width="70" height="70" /></c:otherwise>
                        	</c:choose>
                        </div>
                    </td>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;"></td>
                        </tr>
                        <tr>
...
<!-- 尾部{ -->
<div class="foot">版权所有©神盾局 2016</div>
<!-- }尾部 -->
</body>
</html>