...
<!-- <script type="text/javascript">
	$(document).ready(doFindCompReply());
	
	function doFindCompReply(){
		var compId=$("#compId").val();
		$.ajax({
			url:"${basePath}/sys/home_findCompReply.action",
			type:"post",
			data:{"comp.compId":compId},
			dataType:"json",
...
<body class="rightBody">
   ...
   <div class="tableH2">投诉详细信息<span style="color:red;">(<s:property value='#complainStateMap[comp.state]'/>)</span></div>
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
    	<s:hidden name="comp.compId" id="compId" value="comp.compId"></s:hidden>
        ...
        <tr>
            ...
            <td><s:property value="comp.compContent"/></td>
        </tr>
        <tr><td colspan="2" align="center">受理信息</td></tr>
        <tr>
            <td colspan="2">
            	<s:iterator value="comp.compReplies" status="st">
            		<fieldset style="border: solid 1px #c0c0c0;margin-top:5px;"><legend style="color:green;font-weight:bold;">回复<s:property value="#st.count"/>&nbsp;</legend>
						...
						<div style="width:100%;maring-top:10px;font-size:13px;padding-left:5px;"><s:property value="content"/></div>
					</fieldset>
            	</s:iterator>
            </td>
        </tr>
