...
import com.gf.ims.common.util.PatternTool;

public class PageUtil {
	public static <T> PageResult<T> queryPageDataOracle(JDBC jdbc,
	...
	public static <T> PageResult<T> queryPageData(JDBC jdbc,
			DataSource dataSource, PageTool page, String SQL,
	...
	public static <T> PageResult<T> queryPageDataMysql(JDBC jdbc,
			DataSource dataSource, PageTool page, String SQL,
			Object[] params, Class<T> clazz)
			throws InstantiationException, IllegalAccessException,
			InvocationTargetException, NoSuchMethodException, SQLException {
	...
	private static String appendOraclePageStr(String SQL, PageTool page,
