...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 添加存储柜</span></div>
<div class="content">
 <form id="checkForm" action="<%=path %>/locker/toAdd.do" method="post">
 <div class="toptit"><h1 class="h1tit">存储柜信息</h1></div>
 <ul id="lockerEntity" class="list02a w50"> 
   <li><label>存储柜编号：</label><input name="lockerNum" type="text" value=""/></li>
   <li><label>存储柜面积：</label><input name="lockerVolume" type="text" value=""/></li>
   <li><label>存储柜类型：</label><input name="lockerType" type="text" value=""/></li>
   <li><label>所属货架：</label><input name="goodsNum" type="text" value=""/></li>
   <li><label>清查状态：</label><input name="inventoryStatus" type="text" value=""/></li>
   <li><label>RFID标签：</label><input name="rfidNum" type="text" value=""/></li>
   <li><label>所属货架：</label><select id="storeroom" name="storeroomID">
