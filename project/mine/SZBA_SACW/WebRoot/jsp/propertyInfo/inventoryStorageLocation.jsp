...
<form id="searchForm" action="<%=path%>/storageLocation/queryForPage.do" method="post">
	...
	<div style="height:25px;line-height: 25px;width:300px;">
		<span>原有仓库：<label id="storageName"></label></span>
		<span style="margin-left:5px;">所需库位大小：<label id="storageNum"></label></span>
	</div>
...
var selStorageName=null;
var selStorageNum=null;
...
var preInStorageLocationList={
	startEvent:function(){
		$('#storageName').html(selStorageName);
		$('#storageNum').html(selStorageNum);
			...
			success: function(data){
				if(data!=null){
					...
					for(var i=0;i<data.length;i++){
						...
						+'<input type="hidden" name="locationName" value="'+data[i].locationName+'"/>'
