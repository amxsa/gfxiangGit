...
<body>
	...
	<form id="searchForm" action="<%=path%>/property/queryForPage.do?viewName=countInPropertyList"
		method="post">
		<input type="hidden" name="viewName" value="countInPropertyList" />
		<div class="content">
			<div class="toptit">
			...
			<div class="search"><div class="sp">
				...
				<div class="sbut">
					...
					<input name="" type="button" value="导出" onclick="exportInPro()" />
				</div>
	...
	function searchPro(){
       ...
       f.action="<%=path%>/property/queryForPage.do?viewName=countInPropertyList";
       f.submit();
	}
	
	function exportInPro(){
	   var f = document.getElementById('searchForm');
       f.action="<%=path%>/property/exportInProperty.do?viewName=countInPropertyList";
       f.submit();
	}
</script>
</body>
