...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 财物入库审批</span></div>
...
<div class="content">
	<div class="detal"><h2 class="h4tit">财物入库审批</h2></div>
	...
	<table width="100%" cellpadding="0" cellspacing="1" border="0" class="table">
	  ...
	  <tr class="proTr">
		...
		<td>
			${mapping:mappingProSaveMethod(p.saveMethod) }
		</td>
		<td>
			${p.enviDemand }
		</td>
