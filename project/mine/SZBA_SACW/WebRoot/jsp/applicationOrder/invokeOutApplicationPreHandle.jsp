...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 财物调用审批</span></div>
...
<div class="content">
	<div class="detal"><h2 class="h4tit">财物调用审批</h2></div>
	 ...
	 <input type="hidden" value="" name="proJson"/>
	  <ul class="list02a w50">
	   ...
	   <li class="w50"><label>案件名称：</label>${application.tCase.caseName }</li>
		...
		<%--<c:if test="${application.procedureCode == 'PROCEDURE006' || application.procedureCode == 'PROCEDURE007'}">
		   <li class="w100"><label>计划归还时间：</label>
