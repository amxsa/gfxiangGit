...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 财物处置审批</span></div>
<form action="<%=path%>/applicationOrder/approveHandle.do" method="post">

<input type="hidden" name="handleType" value="handleApplicationPreHandle"/>
<div class="content">
	<div class="detal"><h2 class="h4tit">财物处置审批</h2></div>
	...
	<table width="100%" cellpadding="0" cellspacing="1" border="0" class="table">
	 ...
	 <input type="hidden" value="" name="proJson"/>
	  <ul class="list02a w50">
	   ...
	   <li class="w100"><label>处置方式：</label>${application.disposalDescription}</li>
	   <li class="w100 h50"><label>申请理由依据：</label>
