...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 已审批申请单列表</span></div>
<div class="content">
<form action="<%=path%>/applicationOrder/queryForPage.do?applicationStyle=do" method="post" id="searchForm">
 ...
 <table width="100%" cellpadding="0" cellspacing="1" border="0" id="table_hover" class="table">
  ...
  <tr>
    ...
    <td>${mapping:mappingDepartmentNameById(aRecord.departmentId)}</td>
    ...
    <td><span class="tdbut">
    	<a href="<%=path %>/applicationOrder/queryById.do?applicationId=${aRecord.applicationId }&proId=${aRecord.propertyId}">查看详情</a>
