...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 移库审核列表</span></div>
<div class="content">
 <div class="toptit"><h1 class="h1tit">按条件查询</h1></div>
<form id="searchForm" action="<%=path%>/applicationOrder/queryForMove.do" method="post"> 
 <div class="search">
 <div class="sp">
 ...
 <table width="100%" cellpadding="0" cellspacing="1" border="0" id="table_hover" class="table">
  ...
  <tr>
    ...
    <td>${aRecord.targetStorehouse}</td>
    ...
    <td><span class="tdbut">
    <c:if test="${aRecord.applicationStatus=='N' && aRecord.hisStatus == '1'}"><a href="javascript:void(0)" onclick="doApply('moveApplicationPreHandle','${aRecord.taskId}','${aRecord.applicationId}','${aRecord.procInstId}')">审核</a></c:if>
