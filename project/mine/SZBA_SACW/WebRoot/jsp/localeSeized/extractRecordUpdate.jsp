...
<body>
<div class="crumb">
	<span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 修改<label id="recordTxt"></label></span>
</div>
<div class="content">
	...
	<div id="recordTab" class="idTabs">
		...
		<div class="items">
			...
			<div id="bl">
				...
				<div class="dbut">
					<input type="button" value="修改" id="addRecord"/>
			...
			<div id="zhgc">
				...
				<input name="policeId" id="policeId" type="hidden"/>
				...
				<div class="dbut">
					<input type="button" value="修改" id="addCatchProcess"/>
...
<!-- 笔录js -->
<script language="javascript" src="<%=path%>/jsp/localeSeized/extractRecordUpdate.js"></script>
<!-- 清单js -->
