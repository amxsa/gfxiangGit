...
<body>
	...
	<form id="searchForm" action="<%=path %>/damage/queryForTProPage.do"
		method="post">
		<div class="search">
			<p>
				<label>财物编号</label>
 	...
 	<tr>
	   <td >
	   <input type="hidden" name="proId" id="proId" value="${tProperties.proId }" />
	   <input type="radio" name="proNo" id="proNo" value="${tProperties.proNo }" />
	   </td>
