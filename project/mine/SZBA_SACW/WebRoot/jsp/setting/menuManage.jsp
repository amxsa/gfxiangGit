...
<body>
<div class="crumb"><span>当前位置：<a href="<%=path%>/main.jsp" target="main">首页 </a>>> 菜单管理</span></div>
<div class="content">
<div>
	<div class="menu-list mid_bar" style="width:260px;float:left;"><ul id="menu-list-tree" class="ztree"></ul></div>
	<div class="content1"style="margin-left:270px;">
		...
		<ul class="list02">
       	...
       	<li><label>图标：</label><input id="icon" type="text" value=""/></li>
       	<li><label>描述：</label><input id="description" type="text" value=""/></li>
       	<li><label>级别：</label><input id="levels" type="text" value="" readOnly="true" /></li>
       	<li><label>显示顺序：</label><input id="priority" type="text" value="" readonly/></li>
       	<li><label>是否叶子结点：</label><input id="isLeaf" type="text" value="" readonly/></li>
		</ul>
		<div class="dbut">
